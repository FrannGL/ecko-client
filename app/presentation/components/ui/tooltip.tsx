...
function TooltipProvider({ delayDuration = 0, ...props }: TooltipPrimitive.TooltipProviderProps) {
...
function TooltipContent({ className, sideOffset = 4, ...props }: TooltipPrimitive.TooltipContentProps) {
  return (
