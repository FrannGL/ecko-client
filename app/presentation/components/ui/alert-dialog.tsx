...
function AlertDialogFooter({ className, ...props }: ComponentProps<"div">) {
  return <div data-slot="alert-dialog-footer" className={cn("flex gap-2 justify-end pt-4", className)} {...props} />;
}
...
function AlertDialogCancel({ className, ...props }: ComponentProps<"button">) {
  return (
